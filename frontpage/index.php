      ...
      <div class="row h-100 justify-content-center row-cols-1 row-cols-sm-1 row-cols-md-3 g-5">
        <div class="justify-content-center col-sm-7 col-md-6 col-lg-3">
          ...
          <div class=" card text-center h-100 shadow-0 ">
            <a href="#">
              <img src="img/p5.jpeg" class="card-img-top" alt="Hollywood Sign on The Hill" />
              <div class="card-body">
        ...
        <div class="justify-content-center col-sm-7 col-md-6 col-lg-3">
          <div class=" card text-center h-100 shadow-0 ">
            <a href="#">
              <img src="img/p3.jpeg" class="card-img-top" alt="Hollywood Sign on The Hill" />
              <div class="card-body">
                <p class="fw-bold d-flex justify-content-center card-title">當季展覽</p>
        ...
        <div class="justify-content-center col-sm-7 col-md-6 col-lg-3">
          <div class=" card text-center h-100 shadow-0 ">
            <a href="#">
              <img src="img/p10.jpeg" class="card-img-top" alt="Hollywood Sign on The Hill" />
              <div class="card-body">
        ...
        <div class="justify-content-center col-sm-7 col-md-6 col-lg-3">
          <div class=" card text-center h-100 shadow-0 ">
            <a href="#">
              <img src="img/p1.jpeg" class="card-img-top" alt="Hollywood Sign on The Hill" />
              <div class="card-body">
                <p class="fw-bold d-flex justify-content-center card-title">當季展覽</p>
                <h5 class=" d-flex justify-content-center mt-5 card-text ">
                  揭幕 - 尋探立陶宛攝影中的認同
